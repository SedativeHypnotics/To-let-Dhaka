...
public class Ad implements Serializable {
    ...
    public boolean eligibility(String key){
        if(containsIgnoreCase(this.address,key)) return true;
        if(containsIgnoreCase(this.user,key)) return true;
        if(containsIgnoreCase(this.rent,key)) return true;
        if(containsIgnoreCase(this.date,key)) return true;
        if(containsIgnoreCase(this.category,key)) return true;
        if(containsIgnoreCase(this.contactNo,key)) return true;
        return containsIgnoreCase(this.roomFor, key);
    }
